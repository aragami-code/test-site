...
/*
    ...
    public function contenu_vue_ESP($idproduit){
        $data = array();
        $data['contenu_info']= $this->Vue_Produit_Model->produit_vue_info($idproduit);
        $data['ES_Produit_Serdi_Content'] = $this->load->view('Admin_Serdi/pages/es_vue_produit',$data,TRUE);
        $this->load->view('Admin_Serdi/es_produit_serdi',$data);
