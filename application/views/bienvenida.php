                    ...
                    <div class="clv_right_header">
                        <div class="clv_menu">
                            <div class="clv_menu_nav">
                                <ul>
                                    <li>
                                        <a href="<?php echo base_url('Es/Bienvenida/');?>">Bienvenidas</a>
                                    </li>
                                    <li><a href="#produits">Productos</a></li>
                                    ...
                                    <li><a href="#contact">contacts</a></li>
                                     <li><a>idioma</a>
                                        <ul>
                                            ...
                                            <li><a href="<?php echo base_url('index/');?>"><img src="<?php echo base_url()?>assets/images/flags/francedrapaux.jpg" width="30%">Français</a></li>
   ...
   ">
                        <div class="container">
                            <div class="clv_slide_inner">
                                ...
                                <h1><?php echo $value_slide->titre_slide_es;?></h1>
                                <h2><?php echo $value_slide->description_slide_es;?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="garden_service_block">
                            ...
                            <h3><?php echo $value_info->titreproduitES;?></h3>
                            <p><?php echo $value_info->descriptionproduitES;?></p>
                ...
                <div class="row">
                    ...
                    <div class="col-ld-6 col-md-6">
                        <div class="garden_about_content">
                            <h2> La <br /> solución de software para administrar las actividades de: </h2>
                            <h6> transporte - logística - mensajería </h6>
                            <p> CEIDI CAMERÚN es un editor de software que desarrolla aplicaciones de ticketing
                                 y gestión comercial para el transporte de mercancías y personas en autocar y la geolocalización de todos los vehículos. </p>
                                      <br>
                            <p> ► Un sistema integrado y modular en versiones de estación de trabajo única, multi-agencia, multi-sitio y multi-actividad </p>
                            <p> ► Un sistema de gestión dedicado al mundo del transporte, eficiente y fácil de usar. </p>
                            <p> ► Cumple con las restricciones legales y su forma de trabajar, lo que le permite ahorrar tiempo y dinero. </p>
                            ...
                            <div class="garden_about_blog">
                                <div class="about_blog_inner col-md-6">
                                    ...
                                    <h4>  CEIDI CAMERÚN </h4>
                                    <p> cuenta con una red de distribución que le permite beneficiarse de un servicio rápido y eficiente. </p>
                                </div>
                                <div class="about_blog_inner col-md-6">
                                    <div class="about_blog_image"><img src="<?php echo base_url()?>assets/images/telecon.png" alt="image" /></div>
                                   
<h4> CEIDI CAMERÚN </h4>
                                    <p> tiene en cuenta rápidamente todas sus solicitudes, en cualquier momento y en todas las etapas para responder de manera óptima
                                        a todos sus problemas con su colaboración. </p>
                                </div>
                            </div>
...
<p> Te ofrecemos productos estandarizados y de calidad. </p> </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="blog_slider">
                            ...
                            <div class="swiper-slide">
                                <div class="blog_slide">
                                    ...
                                    <div class="blog_content">
                                        <h4 class="blog_title"><a href="blog_single.html"><?php echo $value_contenu->titreproduitES; ?></a></h4>
                                        
                                      <!--  <p><?php// echo $value_contenu->descriptionproduit; ?></p>-->
                                        <div class="breadcrumb_block" style="background-color: rgba(3,168,17,0.9);">
                                                <ul>
                                                 <li><a href="<?php echo base_url();?>vue-contenu-es/<?php echo $value_contenu->idproduit; ?>">Descriptiones</a></li>
                                             </ul>
                                        </div>
                    ...
                    <span class="slider_arrow blog_left left_arrow">
                        ...
                        <path fill-rule="evenodd"  fill="#0db416"/>
                        </svg>
                    </span>
...
Nuestros servicios</h3>
                      ...
                      <p> Nuestros servicios satisfacen las necesidades digitales actuales. La innovación es nuestra prioridad a la hora de implementar soluciones </p>
                    </div>
                </div>
   ...
   <div class="signup_wrapper">
        <div class="signup_inner">
            <div class="signup_details">
               ...
               <h3> Bienvenido a CEIDI </h3>
                <p> Compañía de estudios de investigación y desarrollo informático </p><ul>
                  
                </ul>
            </div>
            
            <div class="signup_form_section">
                <h4>escríbenos para más información</h4>
                
                <form action="<?php echo base_url('Sendmail/send' )?>" method="post">
                <div class="form_block">
                    
                
                    <input type="text" class="form_field" placeholder="su nombre" name="expediteur" required="on">
                    <br/><br/>
                    <input type="num" class="form_field" 
                    placeholder="Su número de teléfono" name="telephone" required="on">
                    <br/><br/>
                    <input type="mail" class="form_field" placeholder="su email" name="email" required="on">
                    <br/><br/>
                    <input type="text" class="form_field" placeholder="objeto de mensaje" name="objet" required="on">
                    <br/><br/>
                    <textarea class="form_field" placeholder="mensaje" name="descriptionmail" required="on">mensaje


                    </textarea>
                    
                
                <input type="submit" class="btn btn-success" name="submit"  value="enviar a">
                </form>
            </div>
                ...
                <span class="success_close">
                    ...
                    <g>
                        <path fill="#0db416" style="fill-rule:evenodd;clip-rule:evenodd; " d="M131.804,106.491l75.936-75.936c6.99-6.99,6.99-18.323,0-25.312
