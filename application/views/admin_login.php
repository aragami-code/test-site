...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Authentification</b>SERDI</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">entrer vos informations</p>
        <h2 style="color: red">
            <?php $message = $this->session->userdata('login_message');
            if($message)
             {
                 echo $message;
        ...
        <h2 style="color: green">
            <?php $message = $this->session->userdata('success_message');
            if($message)
            {
                echo $message;
        ...
        <form action="<?php echo base_url()?>Admin/admin_login_check" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" name="snom"  placeholder=" le nom">
