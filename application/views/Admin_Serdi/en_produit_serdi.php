...
<div class="clv_main_wrapper index_v4">
                        ...
                        <div class="clv_menu">
                            <div class="clv_menu_nav">
                               <ul>
                                    ...
                                    <li><a href="<?php echo base_url('En/home/#produits');?>">Products</a></li>
                                    <li><a href="<?php echo base_url('En/home/#propos');?>">About</a>
                                       
                                    </li>
                                    <li><a href="<?php echo base_url('En/home/#service');?>">services</a></li>
                                  
                                
                                    <li><a href="<?php echo base_url('En/home/#contact');?>">contacts</a></li>
 <li><a href="#propos">Language</a>
    ...
    <div class="clv_counter_wrapper clv_section" style=" background: url(<?php echo base_url()?>assets/images/Serdiban.jpg) no-repeat;">
         ...
         <?php echo $EN_Produit_Serdi_Content; ?>
        <!--Blog With Sidebar-->
