...
<div class="clv_main_wrapper index_v4">
                    ...
                    <div class="clv_right_header">
                        <div class="clv_menu">
                            <div class="clv_menu_nav">
                                <ul>
                                    <li>
                                        <a href="<?php echo base_url('Es/bienvenida');?>">Bienvenida</a>
                                    </li>



                                    <li><a href="<?php echo base_url('Es/bienvenida/#produits');?>">Productos</a></li>
                                    <li><a href="<?php echo base_url('Es/bienvenida/#propos');?>">A proposito</a>
                                       
                                    </li>
                                    <li><a href="<?php echo base_url('Es/bienvenida/#service');?>">servicios</a></li>
                                  
                                
                                    <li><a href="<?php echo base_url('Es/bienvenida/#contact');?>">contactar</a></li>
                                    
                                     <li><a>idioma</a>
                                        <ul>
                                              <li><a href="<?php echo base_url('index/index');?>"><img src="<?php echo base_url()?>assets/images/flags/francedrapaux.jpg" width="25%">Frances</a></li>
                                             <li><a href="<?php echo base_url('En/home');?>"><img src="<?php echo base_url()?>assets/images/flags/anglaisdrapaux.jpg" width="25%">Ingles</a></li>
    ...
    <div class="clv_counter_wrapper clv_section" style=" background: url(<?php echo base_url()?>assets/images/Serdiban.jpg) no-repeat;">
    	    <div class="container">
         ...
         <?php echo $ES_Produit_Serdi_Content; ?>
        <!--Blog With Sidebar-->
        ...
        <div class="signup_inner">
            ...
            <div class="signup_form_section">
                ...
                <div class="form_block">
                    ...
                    <br/><br/>
                    <input type="num" class="form_field" placeholder="Su número de teléfono" name="telephone" required="on">
                    <br/><br/>
