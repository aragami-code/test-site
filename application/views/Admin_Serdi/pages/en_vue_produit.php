                        ...
                        <div class="blog_left_section">
                            <div class="blog_section">
                                ...
                                <div class="agri_blog_content">
                                    ...
                                    <h3><a href="#"><?php echo $contenu_info->titreproduitEN;?></a></h3>
                                    <div class="blog_user">
                                        <div class="user_name">
                                           <span>
     										</span>
                                    ...
                                    <div class="blog_message">
                                        <p><?php echo $contenu_info->descriptionproduitEN;?></p>
                                        
                                    </div>
                                    <p><p><?php echo $contenu_info->textproduitEN;?></p>
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="blog_sidebar">
                            ...
                            <?php foreach ($contenu_data as $key => $value_contenu):?>
                            				 ...
                            				 <li><a href="javascript:;"><h4 class="blog_title"><a href="<?php echo base_url();?>vue-contenu/<?php echo $value_contenu->idproduit; ?>"><?php echo $value_contenu->titreproduitEN; ?></a></h4></span></a></li>
